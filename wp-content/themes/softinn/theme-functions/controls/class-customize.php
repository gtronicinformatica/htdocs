	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Softme_Customize_Section_Pro(
				...
				'softme',
				array(
                    'pro_text' => esc_html__( 'Upgrade to Softinn Pro','softinn' ),
                    'pro_url'  => 'https://desertthemes.com/themes/softinn-pro/',
                    'priority' => 0
                )
			)
		);
...
Softinn_Customize::get_instance();