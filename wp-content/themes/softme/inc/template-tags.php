        ...
        if ($softme_hs_hdr_search == '1'):
            ...
            <li class="dt_navbar-search-item">
                ...
                <div class="dt_search search--header">
                    <form method="get" class="dt_search-form" action="<?php echo esc_url(home_url('/')); ?>"
                          aria-label="<?php esc_attr_e('pesquise novamente', 'softme'); ?>">
                        <label for="dt_search-form-1">
                            ...
                            <input type="search" id="dt_search-form-1" class="dt_search-field"
                                   placeholder="<?php esc_attr_e('Pesquise aqui', 'softme'); ?>" value="" name="s"/>
                        </label>
                        <button type="submit" class="dt_search-submit search-submit"><i class="fa fa-search"
                                                                                        aria-hidden="true"></i></button>
                    </form>
                    <button type="button" class="dt_search-close">
        ...
        if ($softme_hs_hdr_account == '1'): ?>
            <li class="dt_navbar-user-item">
                <?php if (is_user_logged_in()): ?>
                    <a href="<?php echo esc_url(wp_logout_url(home_url())); ?>" class="dt_user_btn"><i
                                class="fa fa-user"></i></a>

                <?php else: ?>
                    <a href="<?php echo esc_url(wp_login_url(home_url())); ?>" class="dt_user_btn"><i
                                class="fa fa-user"></i></a>
                <?php endif; ?>
            </li>
        <?php endif;
...
if (!function_exists('softme_site_mobile_logo')) :
    function softme_site_mobile_logo()
    {
        ...
        if (!empty($softme_mobile_logo)) { ?>
            <a href="<?php echo esc_url(home_url('/')); ?>" class="custom-logo-link"><img
                        src="<?php echo esc_url($softme_mobile_logo); ?>" class="custom-logo"></a>
        <?php } else { ?>
            <a href="<?php echo esc_url(home_url('/')); ?>" class="site--title">
                <h4 class="site-title">
                    <?php
            ...
            <div class="dt-container">
                <div class="dt-row dt-g-lg-4 dt-g-5">
                    <?php if (is_active_sidebar('softme-footer-widget-1')) : ?>
                        <div class="dt-col-lg-4 dt-col-sm-6 dt-col-12 wow fadeInUp animated" data-wow-delay="00ms"
                    ...
                    <?php if (is_active_sidebar('softme-footer-widget-2')) : ?>
                        <div class="dt-col-lg-4 dt-col-sm-6 dt-col-12 wow fadeInUp animated" data-wow-delay="100ms"
                             data-wow-duration="1500ms">
                    ...
                    <?php if (is_active_sidebar('softme-footer-widget-3')) : ?>
                        <div class="dt-col-lg-4 dt-col-sm-6 dt-col-12 wow fadeInUp animated" data-wow-delay="200ms"
                             data-wow-duration="1500ms">
        ...
        <button type="button" id="dt_uptop" class="dt_uptop">
            <svg class="progress-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102">
                <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98"
                      style="transition: stroke-dashoffset 10ms linear 0s; stroke-dasharray: 307.919, 307.919; stroke-dashoffset: -0.0171453;"></path>
            </svg>
        </button>
    <?php }
    }
