    ...
    <section id="dt_about" class="dt_about dt_about--one dt-py-default front-about">
        <div class="pattern-layer parallax-scene parallax-scene-1">
            ...
            <div data-depth="0.50" class="pattern-2"
                 style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_1.svg);"></div>
            <div data-depth="0.40" class="pattern-3"
                 style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_2.svg);"></div>
            <div data-depth="0.50" class="pattern-4"
                 style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_2.svg);"></div>
        </div>
                ...
                <?php if (!empty($softme_about_left_content)): ?>
                    <div class="dt-col-lg-6 dt-col-md-12 dt-col-sm-12">
                        <div class="dt_image_block style1">
                            <?php
                            //        lucas - editar - manualmente anos                echo do_shortcode($softme_about_left_content);
                            ?>
                            ...
                            <div class="dt_image_box image-1 paroller">
                                ...
                                <figure class="image">
                                    <img src="/wp-content/plugins/desert-companion/inc/themes/softme/assets/images/resource/about-1.jpg"
                                         alt=""/>
                                </figure>
                                <div class="dt_image_video">
                                    <a href="https://youtu.be/MLpWrANjFbI"
                                       class="dt_lightbox_img dt-btn-play2 dt-btn-primary" data-caption="">
                                        <i class="fa fa-play" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="dt_image_box image-2 paroller-2">
                                <figure class="image">
                                    <img src="/wp-content/plugins/desert-companion/inc/themes/softme/assets/images/resource/about-2.jpg"
                                         alt=""/>
                                </figure>
                            </div>
                            <div class="dt_image_text">
                                <span class="dt_count_box">
                                    <span class="dt_count_text" data-speed="2500"
                                          data-stop=" <?php echo(date('Y') - 2001); ?>"></span><span class="text">Anos de Experiência</span>
                                </span>
                            </div>
