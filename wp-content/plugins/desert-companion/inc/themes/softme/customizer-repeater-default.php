...
function softme_get_social_icon_default() {
	return apply_filters(
		'softme_get_social_icon_default', json_encode(
				 array(
				array(
					'icon_value'	  =>  esc_html__( 'fa fa-facebook-f', 'desert-companion' ),
					'link'	  =>  esc_html__( '#', 'desert-companion' ),
					'id'              => 'customizer_repeater_header_social_001',
				),
				array(
					'icon_value'	  =>  esc_html__( 'fa fa-google-plus-g', 'desert-companion' ),
					'link'	  =>  esc_html__( '#', 'desert-companion' ),
					'id'              => 'customizer_repeater_header_social_002',
				),
				array(
					'icon_value'	  =>  esc_html__( 'fa fa-twitter', 'desert-companion' ),
					'link'	  =>  esc_html__( '#', 'desert-companion' ),
					'id'              => 'customizer_repeater_header_social_003',
				),
				array(
					'icon_value'	  =>  esc_html__( 'fa fa-tiktok', 'desert-companion' ),
					'link'	  =>  esc_html__( '#', 'desert-companion' ),
...
function softme_header_email() {
	...
	$softme_hdr_email_icon 	= get_theme_mod( 'softme_hdr_email_icon','fa fa-envelope'); 
...
function softme_header_address() {
	...
	$softme_hdr_top_ads_icon= get_theme_mod( 'softme_hdr_top_ads_icon','fa fa-map-marker
');
...
function softme_header_button() {
	...
	$softme_hdr_btn_icon 		= get_theme_mod( 'softme_hdr_btn_icon','fa-brands fa-whatsapp');
...
function softme_header_contact() {
	...
	$softme_hdr_contact_icon 		= get_theme_mod( 'softme_hdr_contact_icon','fa-brands fa-whatsapp');
...
function softme_header_contact2() {
	...
	$softme_hdr_contact_icon2 		= get_theme_mod( 'softme_hdr_contact_icon2','fa fa-envelope'); 
