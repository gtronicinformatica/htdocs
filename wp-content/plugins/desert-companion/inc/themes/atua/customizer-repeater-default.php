...
function atua_get_social_icon_default() {
	return apply_filters(
		'atua_get_social_icon_default', json_encode(
				...
				array(
					'icon_value'	  =>  esc_html__( 'fa fa-linkedin-in', 'desert-companion' ),
					'link'	  =>  esc_html__( '#', 'desert-companion' ),
...
}elseif( 'Altra' == $desert_activated_theme->name || 'Avvy' == $desert_activated_theme->name || 'Flexea' == $desert_activated_theme->name  || 'Atrux' == $desert_activated_theme->name){
	function atua_information_options_default() {
		return apply_filters(
			'atua_information_options_default', json_encode(
					 array(
