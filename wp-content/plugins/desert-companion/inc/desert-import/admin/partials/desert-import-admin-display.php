 ...
 * @subpackage Desert_Import/admin/partials
 */
?>
<?php
$tehme_data = wp_get_theme();

if ($tehme_data->get('Author') != 'DesertThemes' && $tehme_data->get('Author') != 'DesertThemes') {
    echo '<h3>' . __('Desert Import - This plugin requires Official <a href="https://desertthemes.com/">Desert Themes</a> Theme to be activated to work.', 'desert-companion') . '</h3>';
    ...
    <div class="desert-import-wrap">
		<div class="desert-logo">
			<a href="https://desertthemes.com/" target="_blank">
				<img class="desert_logo" src="<?php echo plugin_dir_url( __FILE__ ) . 'image/logo.svg'; ?>"  alt="DesertThemes">
			</a>
		</div>
                            ...
                            <div class="uk-card theme" style="width: 100%;" tabindex="0">
                                <div class="theme-screenshot">
                                    <?php if ($theme_name != $demo['meta']['theme_name']) { ?>
                                        <span class="dt_ribbon pro">
                                            <?php esc_html_e('Pro','desert-companion'); ?>
                                        </span>
                                        <?php } else { ?>
                                        <span class="dt_ribbon">
                                            <?php esc_html_e('Free','desert-companion'); ?>
                                        </span>
                                    <?php } ?>
									<span class="more-details btn-preview" data-id="<?php echo $demo['id']; ?>" data-live="<?php  if(get_option( 'desert_demo_installed' )== $demo['id']){ echo 1; }?>" data-toggle="modal" data-target="#DesertdemoPreview"><?php esc_html_e('Preview','desert-companion'); ?></span>
                                ...
                                <div class="theme-id-container">
                                    ...
                                    <div class="theme-actions">
                                        ...
                                        <?php } else {
                                            ...
                                            ?>
                                            <a class="button activate live-btn-<?php echo $demo['id']; ?> <?php  if(get_option( 'desert_demo_installed' )!= $demo['id']){ echo "uk-hidden"; }?> " target="_new" data-id="<?php echo $demo['id']; ?>"  href="<?php echo home_url(); ?>"><span class="dashicons dashicons-admin-site-alt3"></span><?php esc_html_e('Live Preview','desert-companion'); ?></a>
                                            <button type="button" class="<?php  if(get_option( 'desert_demo_installed' )== $demo['id']){ echo "uk-hidden"; }?> button activate btn-import btn-import-<?php echo $demo['id']; ?>" href="#" data-id="<?php echo $demo['id']; ?>"><span class="dashicons dashicons-download"></span> <?php esc_html_e('Import','desert-companion'); ?></button>
                                            <?php }  ?>
    ...
    <div class="theme-install-overlay wp-full-overlay expanded iframe-ready" style="display: block;">
        <div class="wp-full-overlay-sidebar">
            ...
            <div class="wp-full-overlay-header">
                ...
                <a class="button activate preview-live-btn uk-hidden" target="_new"  href="<?php echo home_url(); ?>"> <?php esc_html_e('Live Preview','desert-companion'); ?></a>
