 ...
 */
class DST_WP_Import extends WP_Importer {
    ...
    function import_start($file) {
        if (!is_file($file)) {
            ...
            echo __('The file does not exist, please try again.', 'desert-companion') . '</p>';
            $this->footer();
            die();
        }
    ...
    function import_end() {
        ...
        echo '<p>' . __('All done.', 'wordpress-importer') . ' <a href="' . admin_url() . '">' . __('Have fun!', 'desert-companion') . '</a>' . '</p>';
        echo '<p>' . __('Remember to update the passwords and roles of imported users.', 'desert-companion') . '</p>';
...
//		}
        ...
        if ($this->version > $this->max_wxr_version) {
            ...
            printf(__('This WXR file (version %s) may not be supported by this version of the importer. Please consider updating.', 'desert-companion'), esc_html($import_data['version']));
            echo '</strong></p></div>';
        }
    ...
    function get_authors_from_import($import_data) {
        if (!empty($import_data['authors'])) {
            ...
            foreach ($import_data['posts'] as $post) {
                ...
                if (empty($login)) {
                    printf(__('Failed to import author %s. Their posts will be attributed to the current user.', 'desert-companion'), esc_html($post['post_author']));
                    echo '<br />';
                    continue;
                }
